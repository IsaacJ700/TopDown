...
/**********************************************************************
 * Class used to create and place supplies that the user/player can
 * use.
 *
...
public class PlayerSupplies extends GameObject {
	...
	/******************************************************************
	 * Returns the boundaries of the player supplies based on its size
	 * as a rectangle.
     *
    ...
    public Rectangle getBounds() {
		return new Rectangle(getX(), getY(), getSupplySize(),
				getSupplySize());
    }
